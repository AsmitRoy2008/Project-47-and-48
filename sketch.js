...
function draw() 
{
 ...
 if (O1.isTouching(ball) && keyDown("space") && O1.x > ball.y)
 {
   ball.velocityX = random(-8,8);
   ball.velocityY = random(-4,-8);
 }
 ...
 if (O2.isTouching(ball) && keyDown("space") && O2.x > ball.y)
 {
   ball.velocityX = random(-8,8);
   ball.velocityY = random(-4,-8);
 }
 ...
 if (O3.isTouching(ball) && keyDown("space") && O3.x > ball.y)
 {
   ball.velocityX = random(-8,8);
   ball.velocityY = random(-4,-8);
 }
 ...
 if (O4.isTouching(ball) && keyDown("space") && O4.x > ball.y)
 {
   ball.velocityX = random(-8,8);
   ball.velocityY = random(-4,-8);
 }
 ...
 if (O5.isTouching(ball) && keyDown("space") && O5.x > ball.y)
 {
   ball.velocityX = random(-8,8);
   ball.velocityY = random(-4,-8);
 }
 ...
 if (O6.isTouching(ball) && keyDown("space") && O6.x > ball.y)
 {
   ball.velocityX = random(-8,8);
   ball.velocityY = random(-4,-8);
 }
 ...
 if (O7.isTouching(ball) && keyDown("space") && O7.x > ball.y)
 {
   ball.velocityX = random(-8,8);
   ball.velocityY = random(-4,-8);
 }
 ...
 if (O8.isTouching(ball) && keyDown("space") && O8.x > ball.y)
 {
   ball.velocityX = random(-8,8);
   ball.velocityY = random(-4,-8);
 }
 ...
 if (O9.isTouching(ball) && keyDown("space") && O9.x > ball.y)
 {
   ball.velocityX = random(-8,8);
   ball.velocityY = random(-4,-8);
 }
 ...
 if (O10.isTouching(ball) && keyDown("space") && O10.x > ball.y)
 {
   ball.velocityX = random(-8,8);
   ball.velocityY = random(-4,-8);
 }
 ...
 if (O11.isTouching(ball) && keyDown("space") && O11.x > ball.y)
 {
   ball.velocityX = random(-8,8);
   ball.velocityY = random(-4,-8);
 }
